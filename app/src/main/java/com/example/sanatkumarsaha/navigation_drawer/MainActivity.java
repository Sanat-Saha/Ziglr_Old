...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Ziglr");
        actionBar.setCustomView(R.layout.actionbar_view2);
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch (position) {
            ...
            case 6:
                ...
                break;
            case 7:
                objFragment = new menu7();
                break;
            default: objFragment = new menu1();
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_search:
                //Toast.makeText(MainActivity.this, search.getText().toString(),Toast.LENGTH_LONG ).show();
                flag = false;
